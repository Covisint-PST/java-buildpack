  ...
  module Framework
    ...
    class NewRelicAgent < JavaBuildpack::Component::VersionedDependencyComponent
      ...
      def supports?
        ...
        puts !@licenseKey.to_s.empty?
        puts !@licenseKey.to_s.empty? || @application.services.one_service? FILTER, [LICENSE_KEY, LICENSE_KEY_USER]
        !@licenseKey.to_s.empty? || @application.services.one_service? FILTER, [LICENSE_KEY, LICENSE_KEY_USER]
      end
